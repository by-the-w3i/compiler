...
_lr_goto_items = {'program':([0,],[1,]),'statements':([0,],[2,]),'complex_statement':([2,],[3,]),'statement_comment':([2,],[4,]),'optional_statement':([2,],[5,]),'statement':([2,],[6,]),'math_command':([2,],[8,]),'optional_comment':([5,],[40,]),'value':([7,8,10,11,12,13,14,15,17,26,27,28,48,51,52,60,61,63,67,68,69,76,],[42,48,50,51,52,53,54,55,56,67,68,69,71,72,73,75,76,78,80,81,82,85,]),'store_value':([18,42,53,71,],[57,70,74,83,]),}
...
_lr_productions = [
  ...
  ('statement -> AR_PUSH ARRAY_VAR','statement',2,'p_ar_push','bad_and_ugly_interpreter.py',468),
  ('statement -> AR_POP ARRAY_VAR','statement',2,'p_ar_pop','bad_and_ugly_interpreter.py',474),
